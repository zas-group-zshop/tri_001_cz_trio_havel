                    ...
                    <ItemTemplate>
                        <tr class="product">
                            ...
                            <td class="productParam">
                                <%# (ZASutility.MyUtility.StringToNumeric(DataBinder.Eval(Container.DataItem, "zasoba_celkem"))==0 && ZASutility.MyUtility.StringToNumeric(DataBinder.Eval(Container.DataItem, "user_disp_e2"))>0) ? "<span class='objednavka'>Na cestě od dodavatele</span>" : DataBinder.Eval(Container.DataItem, "web_items_stav_skladu") %>
                            </td>
