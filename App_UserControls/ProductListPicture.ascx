...
<asp:Panel runat="server" CssClass="productList product-list-catalog">
    <asp:Repeater ID="rProductListCatalog" runat="server" 
        ...
        <ItemTemplate>
            <asp:Panel ID="pProduktPanel" runat="server" CssClass='<%# "product akce" + (((Container.ItemIndex + 1) % 3 == 0) ? " mod-3" : "") + (((Container.ItemIndex + 1) % 4 == 0) ? " mod-4" : "") + (((Container.ItemIndex + 1) % 2 == 0) ? " mod-2" : "") + (((Container.ItemIndex + 1) % 6 == 0) ? " mod-6" : "") %>'>
            ...
            <!--<asp:Panel runat="server" ID="clearDiv_1" CssClass="border-div clearfix hidden-xs hidden-sm hidden-md visible-lg-block" Visible='<%# ((Container.ItemIndex + 1) % 4 == 0) && this.Page.ToString().Contains("home_aspx") %>' />-->
            <!--<asp:Panel runat="server" ID="clearDiv_2" CssClass="border-div clearfix hidden-xs hidden-sm visible-md-block hidden-lg" Visible='<%# ((Container.ItemIndex + 1) % 3 == 0) && this.Page.ToString().Contains("home_aspx") %>' />-->
            <!--<asp:Panel runat="server" ID="clearDiv_3" CssClass="border-div clearfix hidden-xs hidden-sm visible-md-block visible-lg-block" Visible='<%# ((Container.ItemIndex + 1) % 3 == 0) && !this.Page.ToString().Contains("home_aspx") %>' />-->
